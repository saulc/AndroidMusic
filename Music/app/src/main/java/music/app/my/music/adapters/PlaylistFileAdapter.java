...
public class PlaylistFileAdapter extends RecyclerView.Adapter<PlaylistFileAdapter.ViewHolder>
    ...
    public PlaylistFileAdapter(List<Playlist> items, baseListFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onPlaylistFClicked(holder.mItem);
                }
            }
        });
