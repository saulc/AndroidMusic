...
package music.app.sc.music.player;
...
public class RemoteControlClientCompat {
    ...
    public class MetadataEditorCompat {
         ...
         * qFragCreated with {@link android.media.RemoteControlClient#editMetadata(boolean)}.
         */
        public void clear() {
            if (sHasRemoteControlAPIs) {
                try {
         ...
         * qFragCreated with {@link android.media.RemoteControlClient#editMetadata(boolean)}, or since
     ...
     *     was previously applied to the RemoteControlClient, or true if it is to be qFragCreated empty.
